...
<div class="mathc-live-broadcasts background" style="margin-top: 0px;">
	<div class="broadcast-tabs-wrapper">
		<ul class="nav nav-tabs" role="tablist">
			<li style="border-radius: 30%;background: content-box;"><h1 style="margin-left: 30px;margin-right: 30px;color:white;font-size: 50px;font-family:'Gwangyang'">채널 생성 중 5~10분 소요됩니다.</h1></li>
		</ul>
	</div>
</div>
