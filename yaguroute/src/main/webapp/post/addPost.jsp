            ...
            <div class="row row-offcanvas row-offcanvas-left">
                ...
                <section class="sidebar col-xs-6 col-sm-6 col-md-3 sidebar-offcanvas" id="sidebar">
                    ...
                    <div class="instagram">
                        <h6>instagram</h6>	
                        <ul>
                            <li><a href="#img"><img src="/images/baseball/inst-img.jpg" alt="post image"></a></li>
                            <li><a href="#img"><img src="/images/baseball/inst-img1.jpg" alt="post image"></a></li>
                            <li><a href="#img"><img src="/images/baseball/inst-img3.jpg" alt="post image"></a></li>
                            <li><a href="#img"><img src="/images/baseball/inst-img2.jpg" alt="post image"></a></li>
                        </ul>
                    </div>
                ...
                <section class="news-single col-xs-12 col-sm-12 col-md-9">
                    ...
                    <div class="item">
                        ...
                        <div class="img-wrap">
                            ...
                            <img src="/images/baseball/news-list-img.jpg" alt="news-single">
                        </div>
                        <div class="post-text">
