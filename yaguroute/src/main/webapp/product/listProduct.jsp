			...
			<div class="row">
				...
				<div style="width: 98%; margin-left: 10px;">
					...
					<form name="detailForm">
						...
						<input type="hidden" id="prodTeamCode" name="prodTeamCode"
							value="${prodTeamCode}" /> <input type="hidden" id="currentPage"
						...
						<table width="100%" height="37" border="0" cellpadding="0"
							...
							<tr>
								<td width="15" height="37"><img
									src="/images/product/baseball.png" width="40" height="37" /></td>
						...
						<div class="form-group" style="width: 230px;">
							...
							<input type="text" class="form-control" id="autoComplete"
								name="searchKeyword" placeholder="상품명으로 검색하세요"
