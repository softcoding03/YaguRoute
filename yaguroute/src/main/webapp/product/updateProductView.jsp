...
<section class="hockey-stats">
		   ...
		   <br>
				  <div class="row">
				  <div class="transparency" style="border: 3px;  width: 600px; border-radius: 10px; ">
			...
			<div class="customer-info">
				...
				<div class="col-md-12">
				    <div class="item">
				        <label>
				        	...
				        	<input type="text" placeholder="가격을 입력하세요" name="prodPrice" value="${product.prodPrice}" class="rounded-input" />
				...
				<div class="col-md-6">
				    <div class="item">
				        <label><span><b>상품카테고리</b><i>*</i></span> <select class="basic rounded-select" name="prodCategory">
				            ...
				            <option value="3" ${product.prodCategory == 3 ? "selected" : ""}>의류</option>
				            <option value="4" ${product.prodCategory == 4 ? "selected" : ""}>야구용품</option>
				            <option value="5" ${product.prodCategory == 5 ? "selected" : ""}>잡화</option>			            
				        </select></label>
				    </div>
				</div>
				...
				<div class="col-md-6">
				    <div class="item">
				        ...
				        <label><span><b>구단</b><i>*</i></span> <select class="basic rounded-select" name="prodTeamCode">
				            ...
				            <option value="HH" ${product.prodTeamCode == 'HH' ? 'selected' : ''}>한화이글스</option>
									...
									<div class="item">
										<label> 
											...
											<input type="text" placeholder="수량을 입력하세요" name="prodStock" value="${product.prodStock }" class="rounded-input" />
