...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="prodPrice" value="${product.prodPrice }" class="ct_input_g" 
	...
	<tr>
		<td width="104" class="ct_write">
			상품카테고리 <img src="/images/ct_icon_red.gif" width="3" height="3" align="absmiddle"/>
		</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="price" value="${product.prodCategory}"
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input	type="image" name="prodImages" class="ct_input_g" 
						style="width: 230px; height: 230px" maxLength="13" src="/images/product/${product.prodImages}"/>
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
