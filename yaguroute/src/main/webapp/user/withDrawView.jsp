...
#gnb.gnb_one_pwe .gnb_ico_num .gnb_count {border-radius: 0 13px 13px 0;}</style></head>
	...
	.subindex_greenbox {
	    padding: 16px 17px 0;
	    border-radius: 10px;
	    box-shadow: 1px 2px 14px 0 rgba(0,164,73,.08);
	    border: 0 !important;
...
<header class="header" role="banner">
    ...
    <div class="profile_area">
        <div class="profile_inner">
            ...
            <div class="profile">
                <p class="useid" style="font-size: 26px; font-weight: 700;">${user.userNickName}</p>
    ...
    <div class="account_box">
            <ul class="myinfo_area">
                <li>
                    <div class="myaccount">
                        <div class="myname">
                            <div class="name_text" style="text-align: center; margin-bottom: 20px;"><h2>회원탈퇴</h2></div>
                        </div>
                    </div>
                </li>
            </ul>
</div>					<div style="font-family: monospace; text-align: center; font-size: small; ">
						정말... 탈퇴를 진행하시겠습니까?<br>
                        탈퇴로 인해 발생하는 불이익은 책임지지 않습니다.<br> 
...
<div class="container_1" style="text-align: center; align-items: center;">
        	<div class="row">
					<form>
                                <div class="form-inliney">
                                <a class="weaving" style=" font-weight: bold; font-size: medium; text-align: 20px;"><br>
                                    <label for="password">
                                    	<a class="weaving"> <br>
                                        <input type="password" name="password" id="password" style="width: 375px; height: 50px;"  placeholder="비밀번호를 입력해 주세요." >
                                        </a>
                                    </label>
                                    </a>
                                </div>
                            	...
                            	<label><br><br><br><br>
                                <button type="button" class="btn-upload-file" id="withDraw">탈퇴</button>
                                </label>
                           </div>
                       </form>  
                   </div>
