...
public class PostRestController {
		...
		@PostMapping("addPost/{teamCode}")
		public String addPost(@ModelAttribute("post") Post post, Model model, HttpSession session, @PathVariable String teamCode) throws Exception {
