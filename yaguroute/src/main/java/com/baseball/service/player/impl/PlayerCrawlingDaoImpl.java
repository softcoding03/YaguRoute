...
@Repository("playerCrawlingDaoImpl")
public class PlayerCrawlingDaoImpl implements PlayerCrawlingDao{
	
	@Autowired
	@Qualifier("playerServiceImpl")
	private PlayerService playerService;
	
	public PlayerCrawlingDaoImpl() {
		super();
...
//		playerService.addForeignKey();
		...
		System.setProperty(WEB_DRIVER_ID, WEB_DRIVER_LINUX_PATH);
